<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HaveDoPractice.aspx.cs" Inherits="Studetnt_Practice_HaveDoPractice" %>
                            ...
                            <asp:DataList ID="DataList1" runat="server" BackColor="White" BorderColor="White" BorderStyle="Double" CellPadding="4" Width="474px" Font-Size="9pt" >
                                ...
                                <ItemTemplate>
                                    ...
                                    &nbsp; <asp:Label ID="titleID" runat="server" Height="19px" Width="2px" Font-Size="9pt" Text='<%#Container.ItemIndex+1 %>'></asp:Label>.&nbsp;&nbsp;<%# sub(Eval("Title").ToString()) %><table style="width:246px;font-size:9pt;">
                                        ...
                                        <td colspan="2"><asp:Label ID="optionA" runat="server" Text='<%#Eval("OptionA") %>'></asp:Label></td>
                                        </tr>
                                        <tr>
                                        <td colspan="2">
                                ...
                                <ItemTemplate>
                                    ...
                                    <table style="width:246px;font-size:9pt;">
                                     ...
                                     <tr>
                                         ...
                                         <td ><asp:TextBox ID="stuAnswer" runat="server"  Width="200px" Height="30px" Text='<%#Eval("FAnswer") %>' Enabled="false" CssClass="StuTextBox"></asp:TextBox> </td>
                                         <td style="text-align:center;"><asp:Label ID="Label15" runat="server" ForeColor="Red" Text="(注意: 如果有多个空，答案必须用‘$’隔开)" Font-Size="9pt" Width="250px" Height="20px"></asp:Label></td>
                                     </tr>
                                    </table>
                                </ItemTemplate>
                                <FooterStyle BackColor="White" ForeColor="#333333" />
