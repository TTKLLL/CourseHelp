...
public partial class student_mySingle : System.Web.UI.Page
{
    ...
    protected void bindData()
    {
        ...
        mySingle.DataSource = (from p in db.proc_selectSingle()
    ...
    protected void mySingle_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            order.Text = (mySingle.PageIndex * mySingle.PageSize + e.Row.RowIndex + 1).ToString();
            ...
            Label sIdLabel = (Label)e.Row.Cells[3].FindControl("Label3");
            titleLink.NavigateUrl = "singleDetail.aspx?sId=" + sIdLabel.Text;

        }
    }

    protected void mySingle_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        mySingle.PageIndex = e.NewPageIndex;
        bindData();
    }
